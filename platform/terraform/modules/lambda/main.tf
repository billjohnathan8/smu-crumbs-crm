...
locals {
  ...
  log_function_name       = var.enable_log_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.log[0].function_name : aws_lambda_function.log_mutable[0].function_name) : ""
  log_function_arn        = var.enable_log_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.log[0].arn : aws_lambda_function.log_mutable[0].arn) : ""
  log_function_invoke_arn = var.enable_log_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.log[0].invoke_arn : aws_lambda_function.log_mutable[0].invoke_arn) : ""
  log_function_version    = var.enable_log_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.log[0].version : aws_lambda_function.log_mutable[0].version) : ""

  aml_function_name    = var.enable_aml_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.aml[0].function_name : aws_lambda_function.aml_mutable[0].function_name) : ""
  aml_function_arn     = var.enable_aml_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.aml[0].arn : aws_lambda_function.aml_mutable[0].arn) : ""
  aml_function_version = var.enable_aml_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.aml[0].version : aws_lambda_function.aml_mutable[0].version) : ""

  sftp_transaction_collector_function_name    = var.enable_sftp_transaction_collector ? (local.strict_runtime_ownership ? aws_lambda_function.sftp_transaction_collector[0].function_name : aws_lambda_function.sftp_transaction_collector_mutable[0].function_name) : ""
  sftp_transaction_collector_function_arn     = var.enable_sftp_transaction_collector ? (local.strict_runtime_ownership ? aws_lambda_function.sftp_transaction_collector[0].arn : aws_lambda_function.sftp_transaction_collector_mutable[0].arn) : ""
  sftp_transaction_collector_function_version = var.enable_sftp_transaction_collector ? (local.strict_runtime_ownership ? aws_lambda_function.sftp_transaction_collector[0].version : aws_lambda_function.sftp_transaction_collector_mutable[0].version) : ""

  audit_consumer_function_arn  = var.enable_audit_consumer ? (local.strict_runtime_ownership ? aws_lambda_function.audit_consumer[0].arn : aws_lambda_function.audit_consumer_mutable[0].arn) : ""
  audit_consumer_function_name = var.enable_audit_consumer ? (local.strict_runtime_ownership ? aws_lambda_function.audit_consumer[0].function_name : aws_lambda_function.audit_consumer_mutable[0].function_name) : ""

  aml_consumer_function_arn  = var.enable_aml_consumer ? (local.strict_runtime_ownership ? aws_lambda_function.aml_consumer[0].arn : aws_lambda_function.aml_consumer_mutable[0].arn) : ""
  aml_consumer_function_name = var.enable_aml_consumer ? (local.strict_runtime_ownership ? aws_lambda_function.aml_consumer[0].function_name : aws_lambda_function.aml_consumer_mutable[0].function_name) : ""

  verification_function_name    = var.enable_verification_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.verification[0].function_name : aws_lambda_function.verification_mutable[0].function_name) : ""
  verification_function_arn     = var.enable_verification_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.verification[0].arn : aws_lambda_function.verification_mutable[0].arn) : ""
  verification_function_version = var.enable_verification_lambda ? (local.strict_runtime_ownership ? aws_lambda_function.verification[0].version : aws_lambda_function.verification_mutable[0].version) : ""
}
...
resource "aws_lambda_function" "log" {
  count = var.enable_log_lambda && local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_function" "log_mutable" {
  count = var.enable_log_lambda && !local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_function" "aml" {
  count = var.enable_aml_lambda && local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_function" "aml_mutable" {
  count = var.enable_aml_lambda && !local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_permission" "allow_eventbridge_invoke_aml" {
  ...
  function_name = local.aml_function_name
...
resource "aws_lambda_function" "sftp_transaction_collector" {
  count = var.enable_sftp_transaction_collector && local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_function" "sftp_transaction_collector_mutable" {
  count = var.enable_sftp_transaction_collector && !local.strict_runtime_ownership ? 1 : 0
...
resource "aws_cloudwatch_event_target" "sftp_transaction_collector" {
  ...
  arn       = local.sftp_transaction_collector_function_arn
  input     = "{}"
}
...
resource "aws_lambda_permission" "allow_eventbridge_invoke_sftp_transaction_collector" {
  ...
  action        = "lambda:InvokeFunction"
  function_name = local.sftp_transaction_collector_function_name
  principal     = "events.amazonaws.com"
...
resource "aws_lambda_function" "audit_consumer" {
  count = var.enable_audit_consumer && local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_function" "audit_consumer_mutable" {
  count = var.enable_audit_consumer && !local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_event_source_mapping" "audit_sqs" {
  ...
  function_name           = local.audit_consumer_function_arn
  batch_size              = 10
  enabled                 = true
...
resource "aws_lambda_function" "aml_consumer" {
  count = var.enable_aml_consumer && local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_function" "aml_consumer_mutable" {
  count = var.enable_aml_consumer && !local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_event_source_mapping" "aml_sqs" {
  ...
  function_name           = local.aml_consumer_function_arn
  batch_size              = 10
  enabled                 = true
  function_response_types = ["ReportBatchItemFailures"]
}
...
resource "aws_lambda_function" "verification" {
  count = var.enable_verification_lambda && local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_function" "verification_mutable" {
  count = var.enable_verification_lambda && !local.strict_runtime_ownership ? 1 : 0
...
resource "aws_lambda_permission" "allow_sns_invoke_verification" {
  ...
  action        = "lambda:InvokeFunction"
  function_name = local.verification_function_name
...
resource "aws_sns_topic_subscription" "verification_feedback" {
  ...
  protocol  = "lambda"
  endpoint  = local.verification_function_arn
...
resource "aws_lambda_alias" "log_live" {
  ...
  name             = "live"
  function_name    = local.log_function_name
  function_version = local.log_function_version
}
...
resource "aws_lambda_alias" "aml_live" {
  ...
  name             = "live"
  function_name    = local.aml_function_name
  function_version = local.aml_function_version
}
...
resource "aws_lambda_alias" "sftp_transaction_collector_live" {
  ...
  name             = "live"
  function_name    = local.sftp_transaction_collector_function_name
  function_version = local.sftp_transaction_collector_function_version
}
...
resource "aws_lambda_alias" "verification_live" {
  ...
  name             = "live"
  function_name    = local.verification_function_name
  function_version = local.verification_function_version
}
