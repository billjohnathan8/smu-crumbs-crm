...
class UserAccountServiceTest {
	...
	void setUp() {
		...
		service = new UserAccountService(store, auditLogger);
	}
	...
	void disableUser_rootAdminAccountCannotBeDisabled() {
		...
		assertThrows(AccessDeniedException.class, () -> service.disableUser("usr_1", requester, AUTH_HEADER, CORRELATION_ID));
