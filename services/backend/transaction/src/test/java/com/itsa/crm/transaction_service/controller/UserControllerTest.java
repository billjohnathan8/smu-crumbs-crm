...
import com.itsa.crm.transaction_service.exception.ApiExceptionHandler;
import com.itsa.crm.transaction_service.security.AuthenticatedUser;
import com.itsa.crm.transaction_service.security.RequestAuth;
import com.itsa.crm.transaction_service.security.ForbiddenException;
import com.itsa.crm.transaction_service.service.ClientAccessValidator;
import com.itsa.crm.transaction_service.service.InMemoryTransactionsStore;
import com.itsa.crm.transaction_service.service.TransactionsService;
...
class TransactionsControllerTest {
	...
	void listTransactions_requiresAuth() throws Exception {
		when(requestAuth.requireUser(any())).thenThrow(new com.itsa.crm.transaction_service.security.UnauthorizedException("missing"));
