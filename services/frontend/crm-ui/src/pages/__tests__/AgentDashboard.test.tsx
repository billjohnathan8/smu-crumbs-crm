...
describe("AgentDashboard", () => {
  ...
  it("should display recent activities count", async () => {
    ...
    await waitFor(() => {
      ...
      const recentActivitiesElements =
        screen.getAllByText(/Recent Activities/i);
