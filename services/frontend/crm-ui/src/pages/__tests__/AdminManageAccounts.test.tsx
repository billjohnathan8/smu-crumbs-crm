...
describe("AdminManageAccounts", () => {
  ...
  it("should render page header", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByRole("heading", { name: /Manage Accounts/i }),
      ).toBeInTheDocument();
    });
  });
  ...
  it("should show loading state", async () => {
    vi.spyOn(usersApi, "listUsers").mockImplementation(
      () => new Promise(() => {}),
    );
  ...
  it("should disable user", async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByText(/User disabled successfully/i),
      ).toBeInTheDocument();
    });
  });
  ...
  it("should close modal when clicking cancel", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.queryByRole("heading", { name: /Create New User/i }),
