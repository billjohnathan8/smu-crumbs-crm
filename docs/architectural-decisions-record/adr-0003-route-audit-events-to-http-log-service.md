...
- **Status:** Accepted
- **Deciders:** Team
- **Related:** `services/backend/log-service/app/main.py`, `services/backend/client-service/src/main/java/com/itsa/crm/client_service/logging/HttpClientAuditLogger.java`, `docs/api-contracts/openapi/log.yaml`
...
- **After (HEAD):**
  ...
  - `services/backend/client-service/src/main/java/com/itsa/crm/client_service/logging/HttpClientAuditLogger.java` - sends audit events to log-service over HTTP.
  - `services/backend/client-service/src/main/java/com/itsa/crm/client_service/service/ClientServiceImpl.java` - keeps CRUD successful even if audit publishing fails (warn-level fallback).
...
- Maintain request schema alignment between:
  - `services/backend/client-service/src/main/java/com/itsa/crm/client_service/logging/LogEventRequest.java`
